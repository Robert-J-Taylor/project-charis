...
const HERO_CONTENT = {
  ...
  subheading:
    'Project Charis helps nonprofits save time, find volunteers, and build stronger communities without the burnout.',
  primaryCta: {
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center min-h-screen py-24">
          ...
          >
            ...
            <div className="relative w-80 h-80 lg:w-96 lg:h-96">
              ...
              <div
                className="absolute inset-8 rounded-full border border-[#D5E1EC]/60 animate-ping"
                style={{ animationDelay: '1s' }}
              ></div>
              <div
                className="absolute inset-12 rounded-full border border-[#E2EBF3]/40 animate-ping"
              ...
              <div
                className="absolute top-16 right-12 w-3 h-3 rounded-full bg-[#D5E1EC]/60 animate-bounce"
                style={{ animationDelay: '0.5s' }}
              ></div>
              <div
                className="absolute bottom-12 left-12 w-2 h-2 rounded-full bg-[#E2EBF3]/60 animate-bounce"
                style={{ animationDelay: '1s' }}
              ></div>
              <div
                className="absolute bottom-8 right-8 w-3 h-3 rounded-full bg-[#E4C9A1]/40 animate-bounce"
